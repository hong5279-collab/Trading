...
def evaluate_exit(
    ...
    active_plan: Optional[TradeDecision],
    ...
    if position_qty > 0:
        ...
        if tp2_price is not None and price >= tp2_price:
            return "SELL", "take-profit 2 hit", tp1_price, tp2_price, sl_price, active_stop
        if tp1_price is not None and price >= tp1_price:
            return "SELL", "take-profit 1 hit", tp1_price, tp2_price, sl_price, active_stop
